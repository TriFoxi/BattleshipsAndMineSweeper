...
void resetBoards(bool known, bool unknown)
{
    if (known)
    {
        for (int i = 0; i < 10; i++)
...
bool CheckTemp(string x, string y)
{
    guesses++;
...
void play(int player)
{
    ...
    Console.Write(player);
    Console.Write("'s guesses: ");
    switch (player)
    {
        case 1: Console.WriteLine(p1guesses); break;
        case 2: Console.WriteLine(p2guesses); break;
    }
    guesses = 0;
    Console.ReadLine();
}
